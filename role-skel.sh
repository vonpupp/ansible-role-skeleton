...
# Adapted by Vonpupp <vonpupp@gmail.com>
# - Added Vagrant based on Arch Linux with bridge networking
# - Minor script refactorings
...
git remote add origin "https://vonpupp@github.com/vonpupp/${role_name}.git"
